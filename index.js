...
const GAME_MODES = {
  "Classic": { 
    name: "Classic Trivia", 
    description: "Standard trivia - answer questions, earn points!", 
    questions: 15, 
    timeLimit: 10, 
    icon: "🎯",
    minPlayers: 2,
  ...
  "Speed": { 
    name: "Speed Round", 
    description: "5 second questions - think fast!", 
    questions: 20, 
    timeLimit: 5, 
    icon: "⚡",
    minPlayers: 2,
  ...
  "Survival": { 
    name: "Survival Mode", 
    description: "3 lives - one wrong = lose a life!", 
    questions: 20, 
    timeLimit: 10, 
    icon: "❤️",
    minPlayers: 2,
  ...
  "Betting": { 
    name: "Betting Mode", 
    description: "Bet your points before each question!", 
    questions: 10, 
    timeLimit: 12, 
    icon: "🎰",
    minPlayers: 2,
  ...
  "Lightning": { 
    ...
    description: "Rapid-fire 3 second questions!", 
    questions: 25, 
    timeLimit: 3, 
    icon: "🌩️",
    minPlayers: 2,
  ...
  "Team": { 
    name: "Team Battle", 
    description: "Red vs Blue - work together!", 
    questions: 15, 
    timeLimit: 10, 
    icon: "👥",
    minPlayers: 4,
  ...
  "Blitz": { 
    name: "Blitz Mode", 
    description: "Infinite questions until you miss!", 
    questions: 999, 
    timeLimit: 7, 
    icon: "💥",
    minPlayers: 2,
  ...
  "Reverse": { 
    name: "Reverse Trivia", 
    description: "Guess the question from answers!", 
    questions: 12, 
    timeLimit: 15, 
    icon: "🔄",
    minPlayers: 2,
